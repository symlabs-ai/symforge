...
| Risco | Mitigação |
|-------|-----------|
| Segurança/compliance em plugins de terceiros | Manifesto de permissões, sandbox/timeout, curadoria. |
| Adoção fora de software | Kits BookForge/OpsForge, workshops e exemplos prontos. |
| Dependência de provedores externos | Fallback HIL, abstração de provedores, modo offline onde possível. |
