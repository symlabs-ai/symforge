# 🧠 Symforge — Comunidade de processos e plugins, sem código
_Construa, compartilhe e rode processos em linguagem natural com symbiotas, rollback e plugins no-code._

> Uma biblioteca viva de processos e integrações: use, adapte ou publique o seu para produto, editorial, operações, compliance ou pesquisa.
...
| Etapa | Descrição |
|-------|-----------|
| Input | Escolha um processo da biblioteca ou escreva em linguagem natural/YAML. |
| Engine | Symbiotas executam, validam e registram; plugins no-code entregam e transformam outputs. |
| Output | Processo rodado com provas, decisões rastreadas e artefatos enviados nos canais certos. |
...
## 📩 Chamada à Ação
> Entre na comunidade Symforge: rode um processo existente, publique um plugin sem código ou proponha um novo fluxo para seu domínio. Vamos medir governança, velocidade e qualidade juntos.

---

## 📎 Rodapé / Créditos
Symforge — processos como código, symbiotas e plugins no-code para qualquer domínio. Contato: hello@symforge.dev
