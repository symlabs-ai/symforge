# 🧩 Template — Hipótese de Mercado (MDD)

## 🎯 Propósito

O arquivo `hipotese.md` é o ponto de partida de qualquer ciclo MDD.
Ele registra a **intuição inicial** ou **pressentimento de oportunidade** percebido pelo stakeholder, antes mesmo de existir um produto ou visão estruturada.

A hipótese deve capturar **o que se percebeu**, **quem foi impactado** e **por que isso parece relevante agora**.

> **Dica:** Seja breve, direto e intuitivo — este documento representa uma centelha, não uma justificativa completa.
...
## 6. Impacto Esperado
Se essa hipótese se confirmar, qual transformação isso poderá gerar para o público e para a organização?

> Exemplo: “Maior adesão a soluções IA em contextos offline e diferenciação competitiva no mercado B2B industrial.”
...
## 8. Grau de Certeza
Avalie seu nível de confiança nesta hipótese (de 0% a 100%) e o motivo.

| Nível de Certeza | Motivo |
|------------------|---------|
| [ ] 0–25% | Puro palpite |
| [ ] 25–50% | Indícios iniciais |
| [ ] 50–75% | Sinais consistentes |
| [ ] 75–100% | Evidência forte / confirmação de mercado |
