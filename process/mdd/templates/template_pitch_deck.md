# 🧩 Template — Pitch de Valor (MDD)

## 🎯 Propósito

O `pitch_deck.md` transforma o conteúdo estratégico do **sumário executivo** em uma **narrativa visual e envolvente**.
Seu objetivo é comunicar o valor do produto de forma clara, emocional e inspiradora — tanto para investidores quanto para parceiros e público em geral.

> **Dica:** O pitch é uma história curta. Cada bloco representa uma “tela” ou slide que será renderizado em HTML pelo MDD Publisher.
...
## ⚙️ 4. Como Funciona
Mostre, de maneira simplificada, como a solução entrega valor.

| Etapa | Descrição |
|--------|------------|
| Input | O cliente envia seus próprios dados. |
| Engine | A IA processa localmente. |
| Output | O resultado é entregue com total privacidade. |
...
## 🧭 7. Roadmap
Apresente os marcos de desenvolvimento e crescimento.

| Fase | Objetivo | Resultado Esperado |
|------|-----------|--------------------|
| Fase 1 | Prototipagem | MVP validado em 3 clientes. |
| Fase 2 | Lançamento | Beta público com 100 usuários. |
| Fase 3 | Escala | Parcerias e expansão internacional. |
...
## 🧑‍💼 9. Time
Apresente brevemente as pessoas-chave.
| Nome | Função | Competência Principal |
|------|---------|------------------------|
| [Nome 1] | CEO | Estratégia e visão de mercado. |
| [Nome 2] | CTO | Arquitetura técnica e IA. |
